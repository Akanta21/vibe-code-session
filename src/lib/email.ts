...
export async function sendPaymentEmail(
      ...
      <div class="content">
        ...
        <div class="instructions">
          ...
          <ol>
            ...
            <li><strong>Important:</strong> Include reference <code>${paynowReference}</code> in your transfer</li>
          </ol>
          <p><strong>⚠️ Payment Deadline:</strong> Please complete payment within 24 hours to secure your spot.</p>
        </div>

        ${
          registration.vibeCode
            ? `
        <div class="instructions" style="background: #fef3c7; border: 1px solid #f59e0b;">
          <h3 style="color: #d97706;">🤖 Your AI-Generated Vibe Code</h3>
          <p>We've crafted a personalized project specification just for you based on your idea: "<em>${
            registration.projectIdea
          }</em>"</p>
          <p>📎 <strong>Check your attachments for "${registration.name.replace(
            /[^a-zA-Z0-9]/g,
            '_'
          )}_Vibe_Code.md"</strong> - this is your personalized blueprint for the workshop!</p>
          <p style="font-size: 14px; color: #92400e; margin-top: 15px;">💡 <strong>Tip:</strong> Download and review this specification before the workshop to get excited about what you'll build!</p>
        </div>
        `
            : ''
        }
  ...
  try {
    ...
    // Add vibe code as markdown attachment if available
    if (registration.vibeCode) {
      const vibeMarkdown = `# 🎨 Your Vibe Code Specification

**Generated for:** ${registration.name}
...
*This specification was generated by AI to help guide your project development during the Vibe Coding workshop. Use it as inspiration and feel free to adapt it as you build!*
...
`;
      ...
      emailOptions.attachments.push({
        ...
        content: Buffer.from(vibeMarkdown, 'utf-8'),
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Registration confirmed! See you November 13, 2025.</p>
        ...
        <div class="event-card">
          ...
          ${
            registration.jobTitle
              ? `<p style="opacity: 0.9; margin: 5px 0;">${registration.jobTitle}</p>`
              : ''
          }
        ...
        <div class="event-info">
          ...
          <div class="info-row">
            ...
            <span class="info-value">November 13, 2025 • 6:30 PM - 9:00 PM</span>
          </div>
          <div class="info-row">
